...
const PrincipalMessage = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col gap-18 items-center max-w-max mx-auto md:h-screen py-4 px-4 ">
      ...
      <div className="space-y-5 max-w-sm lg:max-w-xl">
        ...
        <p className="block sm:hidden text-lg font-medium text-justify">
        ...
        <p className="flex flex-col gap-1">
          <span className="font-bold text-xl ">Mr. Bir Bikram Shah</span>
