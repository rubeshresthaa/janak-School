...
//         <Link href="#blog" smooth>Blog</Link>
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-96 py-8 bg-white">
            ...
            <div className="flex flex-col gap-4 p-3 font-medium text-lg">
              <Link href="#home" className="border-b-2 border-black pb-2">Home</Link>
              <Link href="#blog" className="border-b-2 border-black pb-2">Blog</Link>
              <Link href="#contact" className="border-b-2 border-black pb-2">Contact</Link>
            </div>
          </SheetContent>
        </Sheet>
      </div>
