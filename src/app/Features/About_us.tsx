...
//     },
//     {
//       image: "https://images.unsplash.com/photo-1554721299-e0b8aa7666ce?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
//     },
//     {
//       image: "https://images.unsplash.com/photo-1554721299-e0b8aa7666ce?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
//     },
...
//     },
//     {
//       image: "https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
//     },,
//     {
//       image: "https://images.unsplash.com/photo-1607453998774-d533f65dac99?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGNoaWxkcmVuJTIwc2Nob29sfGVufDB8fDB8fHww",
//     },
//   ];

//   return (
//     <div className="my-4 mx-8 lg:mx-20">
//       <h1 className="text-center text-2xl text-black font-bold font-poppins">About Us</h1>
//       <FaChevronDown size={20} className="text-black m-auto hover:scale-125 cursor-pointer" />
//       <div>
//         <h1 className="text-center font-bold text-red-800 text-md lg:text-3xl font-poppins">Welcome to Janak Smriti Secondary School</h1>
//         <div className="my-5 lg:mx-8">
//           <p className="text-justify lg:text-center text-md my-4">
//             Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi qui distinctio consequatur, porro dolores, earum
//             assumenda nihil error voluptatibus vitae voluptatum? Nihil dolor voluptates fuga eaque nemo, veritatis
//             exercitationem vel. Dolore, sapiente maiores magni quidem architecto atque. Quia porro blanditiis nostrum sequi
//             labore iure architecto? Consectetur quae a accusantium iure.
//           </p>
//           <div>
//           <Carousel>
//   <CarouselContent>
...
//             </div>
//             </CarouselItem>
//     <CarouselItem> <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8">
