...
const Blogs = () => {
  const blogCollection = [
    ...
    },
    {
      id: 2,
      title:
        "Stay Positive, Stay Strong The Power of Positive Thinking in Student Life",
      image:
  ...
  return (
    <div className="my-3 w-full bg-white py-4" id="blog">
      <h1 className="text-center font-bold text-red-800 text-2xl  sm:text-4xl">
        Blogs
      </h1>
      <Carousel>
        <CarouselContent>
            ...
            return (
              <CarouselItem key={index}>
                <div className="relative space-y-2 my-3 lg:px-20">
                  <h1 className="text-center text-base sm:text-2xl lg:text-3xl font-bold">
                    {blog.title}
                  </h1>
                  <p className="text-justify px-2 py-2 lg:px-4 lg:py-4">
                    {blog.description}
                  </p>
                ...
                <div className="flex items-center justify-center">
                  <Link
                    href={`/blog/${blog.id}`}
                    className="p-2 sm:p-4 w-fit  md:w-54 bg-green-500 sm:text-lg text-white hover:bg-green-700 cursor-pointer rounded-md text-center"
                  >
                    Read More
                  </Link>
                </div>
